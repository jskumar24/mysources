...
# Mashreq Restric Public IP Address
$definitionMashreqRestricPublicIPAddress = New-AzureRmPolicyDefinition `
    -Name "MashreqRestricPublicIPAddress" `
    -DisplayName "MashreqRestricPublicIPAddress" `
...
$mashreqRestricPublicIPAddress = Get-AzureRmPolicyDefinition -Name MashreqRestricPublicIPAddress
New-AzureRmPolicyAssignment `
    -Name "MashreqRestricPublicIPAddress" `
    -PolicyDefinition $mashreqRestricPublicIPAddress `
    -description "This policy forces the VM creation with Managed Disk Only." `
    -Scope /subscriptions/$defaultSubscriptionId

# # Destory the local variables
$definitionMashreqRestricPublicIPAddress = @{ }
$mashreqRestricPublicIPAddress = @{ }
